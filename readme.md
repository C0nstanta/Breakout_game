...
<h3>Наконец добавлен первый тест на проверку keyboard</h3>
<h3>Сложности возникли с тем, что состояние переменных внутри постоянно менялось состояние</h3>
<h3>Проблему удалось решить с помощью передачи между двумя потоками текущего состояния</h3>
